...
- Google-first presenter generation uses Gemini Enterprise Agent Platform as the only supported Google model platform, while provider-neutral boundaries remain in place for future replacement; the current Developer/Vertex implementation split is transitional and pending correction;
