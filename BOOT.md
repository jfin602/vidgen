...
- Initial provider direction: Google-first through Gemini Enterprise Agent Platform only, with text, video, and speech capabilities kept behind thin provider-neutral boundaries and capability-specific authentication.
- MVP assembly: FFmpeg.
